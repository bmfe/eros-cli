...
var os = require('os'),
    ...
    webpackRun = require('./webpack.config.js');
...
gulp.task('default', gulpSequence(
    'clean', ['build-iconfont'], ['md5:css', 'md5:js']
));
...
gulp.task('dev', gulpSequence(
    'clean', ['build-assets', 'build-iconfont', 'build-mock'], ['build-css', 'build-js'], ['mock', 'watch', 'open']
));
